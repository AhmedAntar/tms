...
<?php include 'connection.php'; ?>
	    ...
	    <!--  gallary-intro section  -->
		<section class="gallary-intro border">
      <div class="overlay">
       <div class="container-fluid">
               <div class="d1">
                  <div class="d2 ">
                      <h2 class=" display-3 font-weight-bolder">Gallary Studio</h2>
                  </div>
               </div>
            </div>
       </div><!--   container  -->
    ...
    <section class="projects-section">
        <h2>Our <span class="text-warning">Moments</span></h2>		
