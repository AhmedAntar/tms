...
<html lang="en">
  <head>
    ...
    <form >
        <center><img src="img/std.png" class="img1"></center>
		<h2>Sign-Up</h2>
        ...
        <div class="form-group">
			<div class="row"> 
				...
				<div class="col"><input type="text" class="form-control" name="first_name" placeholder="First Name" autofocus required="required"></div>
